...
public class Coder {
	...
	public static byte[] decryptDES(byte[] src) throws Exception{
		...
		log.info("字节数组值为:"+enk);
		SecretKey deskey = new SecretKeySpec(enk, algorithm);
		log.info("加密后的key:"+deskey.toString());
		Cipher c1 = Cipher.getInstance(algorithm); 
		log.info(c1.toString());
		c1.init(Cipher.DECRYPT_MODE, deskey);
		log.info("初始话后的为:"+c1.toString()+"返回的手机号为:"+c1.doFinal(src));
		return c1.doFinal(src);
	}
	...
	/*
	 * public static void main(String[] args) throws Exception { Coder coder = new
	 * Coder(); coder.decodeDES("18202587139"); }
	 */
   ...
   public static void main(String[] args) throws Exception {
	   System.out.print(encodeDES("13359912366"));
	   System.out.println(decodeDES("0aFNQfaGMBa1p2Cbg0PMow=="));
		/*
		 * System.out.println(encodeMD5("juzhengjiaoyu", "juzhengjiaoyu"));
		 * System.out.println(encodeDES("13920285501")+decodeDES(
		 * "f864802e9be43b73eb2366725661add3"));
		 * System.out.println(encodeDES("15620611773"));
		 * System.out.println(encodeDES("13002208106"));
		 * System.out.println(encodeDES("13102172652"));
		 * System.out.println(encodeMD5("6ac6a79565663faff0bdcdf982680792",
		 * "AF34261587B44F7BB101FF91092A58704845038278523"));
		 */
	} 
}
